...
def menu():
    ...
    if len(proxies) != 0:
        os.system('title Discord Generator ^| Vice Huara ^| PROXY LIST DETECTED')

    else:
        os.system('title Discord Generator ^| Vice Huara ')
    UI.banner()
    UI.start_menu()
...
def main():
    ...
    if continue_program:
        ...
        if user_thread:
            ...
            if len(proxies) != 0:
                os.system('title Discord Generator by Vice Huara ^| Proxy: True ^| Threading: True')
                ...
                os.system('title Discord Generator by Vice Huara ^| Proxy: False ^| Threading: True')
            ...
            if len(proxies) != 0:
                os.system('title Discord Generator by Vice Huara ^| Proxy: True ^| Threading: False')
                worker(random.choice(proxies))

            else:
                os.system('title Discord Generator by Vice Huara ^| Proxy: False ^| Threading: False')
                worker()    
